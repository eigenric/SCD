...
void funcion_hebra_p1()
{
    while (true)
    {
        ...
        while (c2 == 0)
        {
            ...
            if (turno == 2)
            {
                cout << "Turno 2 y P2 con intención entrar SC. " << endl;
                while (turno == 2)
        ...
        cout << "P1. Inicio Sección Crítica" << flush;
        x++;
        cout << "x= " << x << endl;
        turno = 2;
...
void funcion_hebra_p2()
{
    while (true)
    {
        ...
        while (c1 == 0)
        {
            ...
            if (turno == 1) 
            {
                cout << "       Turno 1 y P1 con intención entrar SC. " << endl;
                while (turno == 1)
        ...
        c2 = 1;
        cout << "       P2. Fin Sección Crítica" << endl;
    }
}
