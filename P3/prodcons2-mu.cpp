...
// en orden arbitrario
// Versión Multiples Productoeres y Múltiples Consumidores
//
// Historial:
...
void funcion_productor(int id_productor)
{
   ...
   {
      // producir valor
      int valor_prod = producir(id_productor, j);
      // enviar valor
...
void funcion_buffer()
{
   ...
   for( unsigned int i=0 ; i < num_items*2 ; i++ )
   {
      ...
      switch( estado.MPI_TAG ) // leer tag del mensaje en metadatos
      {
