...
void funcion_camarero() {
    int valor, id_filosofo, num_sentados = 0, 
    ...
    while (true) {
        ...
        MPI_Recv(&valor, tamanio_recibido, MPI_INT, id_filosofo, etiq_aceptada, MPI_COMM_WORLD, &estado);
        ...
        } else {    // estado.MPI_TAG == etiq_levantarse
            num_sentados--;
        }
    }
}
