...
void funcion_camarero() {
    int valor, id_filosofo, num_sentados = 0, etiq_aceptable,
        propina = 0, no_ciclos_necesarios = 1, tamanio_recibido, propina_recibida;
    MPI_Status estado;
    ...
    while (true) {
        ...
        cout << "TAM RECIBIDO: " << tamanio_recibido << endl;
        propina_recibida = tamanio_recibido;
        cout << "PROPINA RECIBIDA: " << propina_recibida << endl;
        ...
        /*switch (estado.MPI_TAG) {
            case TAG_SENTARSE:
                ...
                cout << "--[S]-- Filósofo " << id_filosofo << " se sienta en la mesa, ha enviado propina de " << tamanio_recibido << endl;//WIP<< ", ahora propina es " << propina << endl;
                num_sentados++;
        ...
        cout << "TAM2: " << propina_recibida << endl;
        
        if ( estado.MPI_TAG == TAG_SENTARSE ) {
            cout << "TAMAÑO: " << propina_recibida << endl;
            propina += propina_recibida;
            cout << "--[S]-- Filósofo " << id_filosofo << " se sienta en la mesa, ha enviado propina de " << propina_recibida << endl;//WIP<< ", ahora propina es " << propina << endl;
            cout << "----- PROPINA TOTAL " << propina << " -------" << endl;
            cout << "------- no_ciclos_necesarios * 10 = " << no_ciclos_necesarios * 10 << endl;
            num_sentados++;
        ...
        //WIPcout << "Tenemos sentados " << num_sentados << " filósofos" << endl;
    }
}
